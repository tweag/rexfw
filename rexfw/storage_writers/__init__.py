...
class AbstractStorageWriter(metaclass=ABCMeta):
    @staticmethod
    @abstractmethod
...
class AbstractFileSystemStorageWriter(AbstractStorageWriter):
...
class FileSystemPickleStorageWriter(AbstractFileSystemStorageWriter):
...
class CloudPickleStorageWriter(AbstractStorageWriter):
...
class FileSystemStringStorageWriter(AbstractStorageWriter):
